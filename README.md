# MemPrOD-Membrane-Protein-Orientation-and-Distortions-
MemPrOD is a program the predicts the distortions of a lipid bilayer around a membrane protein. The paper associated with is code is available [here]. 
